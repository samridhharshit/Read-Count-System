...
export default function ReadStory() {
    return (
        <div className="container col-lg-9 align-content-center">
            ...
            <br />
            <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sed semper
                libero. Sed
                ...
                imperdiet odio
                ac, porta orci. Duis elit diam, tincidunt et libero vitae, bibendum cursus tellus. Nam
                maximus
                diam eu
                nisi suscipit, quis porta lorem posuere. In vulputate libero ex, quis condimentum arcu
                hendrerit
                blandit. Morbi sit amet semper purus. Pellentesque pharetra sem metus, vitae lobortis lacus
                tincidunt
                id.

                Curabitur efficitur ultrices tincidunt. Suspendisse consequat aliquam lacus ac vulputate.
                Aenean
                ...
                Praesent cursus, odio sed fringilla ullamcorper, enim lorem tempus massa, sit amet
                condimentum
                libero
                sapien ac odio. Suspendisse potenti. Cras venenatis mi a lacus porta, nec consequat nibh
                dictum.
                Aliquam
                mi risus, fringilla et ornare sed, rutrum non ante. Aliquam erat volutpat. Nam ornare
                facilisis
                gravida.
                Nam volutpat lobortis urna, sit amet finibus orci. Sed id finibus leo. Integer vitae egestas
                lorem.
                Nullam in ultrices ipsum, ut dignissim ante. Praesent bibendum, nunc nec eleifend
                sollicitudin,
                mauris
                elit fermentum risus, sit amet feugiat quam purus et quam. Lorem ipsum dolor sit amet,
                consectetur adipiscing elit. Sed sed semper
                libero. Sed
                tempus ultricies magna eget viverra. Nullam aliquam, ante id congue malesuada, erat ligula
                interdum
                ipsum, sit amet pulvinar urna diam sit amet odio. Vivamus tempor sem at elit pharetra dictum
